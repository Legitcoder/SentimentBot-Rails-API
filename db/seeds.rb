...
for _ in 0..10
  manager = User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.email, is_admin: true, phone: Faker::PhoneNumber.phone_number)
  managers << manager
  manager.save
end
...
for _ in 0..400
  response = Response.create(mood: Faker::Lorem.word, emoji: emojis.sample, survey: surveys.sample, user: users.sample, longitude: "-73.935242", latitude: "40.730610", date: Faker::Date.backward(100))
  responses << response
  response.save()
end
